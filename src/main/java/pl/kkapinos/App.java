...
public class App {
    ...
    ProductCatalog createNewProductCatalog() {
        ...
        String productId1 = productCatalog.addProduct("Sila stresu", "Kelly McGonigal", "serum");
        ...
        String productId2 = productCatalog.addProduct("Sila stresu", "Kelly McGonigal", "serum");
        ...
        String productId3 = productCatalog.addProduct("Sila stresu", "Kelly McGonigal", "serum");
        ...
        String productId4 = productCatalog.addProduct("Serum", "Kelly McGonigal", "serum");
        ...
        String productId5 = productCatalog.addProduct("Sila stresu", "Kelly McGonigal", "serum");
